...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#0a0a0a] text-white pt-24 pb-12 px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3 text-primary font-sans font-bold tracking-widest uppercase text-sm">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square" className="mt-0.5 flex-shrink-0">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                  <circle cx="12" cy="10" r="3"></circle>
                </svg>
                <span className="leading-snug text-left">Doha, Qatar, Industrial Area,<br/>Street No 10</span>
              </div>
              <div className="flex items-center gap-3 text-primary font-sans font-bold tracking-widest uppercase text-sm">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <span>+974 7193 2024</span>
              </div>
            </div>
          </div>
